...
<body>
		...
		<div class="content">	
			<div class="update">
				<div class="container">
					<h2>Ulogujete se da biste zavrsili kupovinu</h2>
					<?php
                        if($errorMessage != ''){
                            ?>
                    ...
                    <form method="POST" action="uloguj.php">
                        ...
                        <hr>
                        <input type="submit" value="Uloguj se" class="btn-primary btn btn-lg">
                    </form>
                    <a href="registrovanje.php" > Nemate nalog? Napravite jedan!</a>
                </div>
            </div>
        </div>
